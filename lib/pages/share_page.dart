...
import 'package:secure_share/services/wifi_sharing_sender.dart';
                ...
                child: Column(
                  children: [
                    GradientButton(
                      ...
                      darkColors: const [Color(0xFF4C56E1), Color(0xFF0B1567)],
                    ),
                    ...
                    GradientButton(
                      onPressed: () {
                        ///implement the wifi sharing procedure.
                        // WifiSharingSender().startSharingProcess(context);
                      },

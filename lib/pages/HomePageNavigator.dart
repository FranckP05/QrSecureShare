...
class HomeNavigator extends StatefulWidget {
  ...
  const HomeNavigator({super.key, required this.toggleTheme, required this.username});
...
class _HomeNavigatorState extends State<HomeNavigator> {
  ...
  String get user => widget.username;
    ...
    return Scaffold(
      body: PageView(
        ...
        children: [
          ...
          HistoryWidget(toggleTheme: widget.toggleTheme, username: user,),
        ],
      ),

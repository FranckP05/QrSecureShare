...
class _WifiSharingScreenState extends State<WifiSharingScreen> {
  ...
  bool _showQrCode = false; // Pour contrôler l'animation
  ...
  // Génère le QR code pour le Wi-Fi
  void _generateQrCode() {
    ...
    // Format du QR code pour le Wi-Fi : WIFI:S:<SSID>;T:WPA;P:<PASSWORD>;;
    final wifiData =
    ...
    Future.delayed(const Duration(seconds: 1), () {
      setState(() {
        _qrData = wifiData;
        _isLoading = false;
        _showQrCode = true; // Déclenche l'animation
      });

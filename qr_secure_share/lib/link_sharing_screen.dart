            ...
            ElevatedButton.icon(
              onPressed: () {
                showModalBottomSheet(
                  context: context,
                  isDismissible:
                      true, // Permet de fermer en appuyant à l'extérieur
                  enableDrag:
                      true, // Permet de faire glisser pour fermer avec une animation
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  ...
                                  icon: const FaIcon(
                                    FontAwesomeIcons
                                        .chevronDown, // Icône améliorée (flèche vers le bas)
                                    color: Color(0xFF1E88E5),
                                  ),

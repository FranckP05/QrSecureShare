...
// Commenté car kIsWeb n'est pas utilisé tant que le Bluetooth est désactivé
...
class _LinkReceptionScreenState extends State<LinkReceptionScreen> {
  ...
  // Commenté car cette variable n'est pas utilisée tant que le Bluetooth est désactivé
  ...
  // Reçoit des données via Bluetooth (exemple simplifié)

...
import 'package:qr_code_scanner/qr_code_scanner.dart'; // Importation sans condition
import 'package:qr_flutter/qr_flutter.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:permission_handler/permission_handler.dart'; // Importation sans condition
...
class _ScanScreenState extends State<ScanScreen> {
  ...
  // Demande la permission d'accès à la caméra (uniquement sur mobile)
  ...
  // Envoie des données via Bluetooth (exemple simplifié)
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) async {
      ...
      // Demander confirmation pour envoyer après scan

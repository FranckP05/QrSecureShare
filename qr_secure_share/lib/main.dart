...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => HomeScreen(
            onToggleTheme: _toggleTheme), // Ajout de onToggleTheme ici
        '/link_sharing': (context) => const LinkSharingScreen(),
        '/link_reception': (context) =>
            const LinkReceptionScreen(link: ''), // Valeur par défaut temporaire
        '/scan': (context) => const ScanScreen(),
        '/password_sharing': (context) => const PasswordSharingScreen(),
        '/wifi_sharing': (context) => const WifiSharingScreen(),
        '/file_sharing': (context) => const FileSharingScreen(),
      },
    );
  }
}
